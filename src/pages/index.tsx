...
export const getStaticProps: GetStaticProps = async () => {
  ...
  const productsRes = await fetch(
    `https://pranaair.com/wp-json/wc/v3/products?consumer_key=ck_d3f818f4910619c28fa8b2ed8f8d3ac81ebcdfd6&consumer_secret=cs_bd45f75058ee51aa277b50115b6bf9ab61416482=${Date.now()}`
  );
